...
| TEMP-R1 / ADR 0006 | ACCEPTED HUMAN DECISION | [ADR 0006](./decisions/0006-source-time-semantics.md) | TEMP-D1–D5 accepted 2026-09-23; branch vladimir/temp-r1-source-time-semantics |
...
| TEMP-R1 / ADR 0006 | **ACCEPTED HUMAN DECISION / IMPLEMENTED IN CHANGESET** | Reconciles collection serving with continuous UTC+3 sponsor timestamps; preserves D2R 18-batch cohort; Human Integration is a separate repository gate |
