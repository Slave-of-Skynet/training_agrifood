...
- **VLD-03 (2026-09-23):** [End-to-end integration and behaviour evidence](./recon/VLD-03-end-to-end-integration.md) is **EVIDENCE COMPLETE / ACCEPTABLE IN CHANGESET** on PR #52's committed base. Real runtime/API/browser checks, synthetic collection fault injection, lookup race, and mobile behavior were exercised. VLD-03 has not itself been Human Integrated; this status does not authorize merge or deployment.
...
The initial runtime slice (offline artifact generation/validation, runtime loading, lifespan/provider, single-batch GET, health reconciliation and focused verification) is implemented in code and integrated via RBS-01 / PR #42. PUX-11A / PR #46 implemented frontend consumption of the real single-batch route. IGR-05B / PR #49 implemented backend multi-batch/replay serving, facility filtering, ranking and pagination. TEMP-R1 / PR #51 integrated UTC+03 source-time semantics. PUX-12A frontend collection queue/presentation was Human Integrated through PR #52. VLD-03 integration evidence is complete in this changeset; database, learned/recommendation/deterioration engines, new confidence/minimum policy, comparability, background retraining, hot reload, and deployment remain deferred. If a valid canonical input cannot legitimately be assessed by the existing baseline: **STOP — HUMAN DECISION REQUIRED**. Dataset-backed simulation is not the synthetic fixture; fixture semantics remain unchanged and simulation=false remains outside HG-R5.
...
| VLD-03 | EVIDENCE COMPLETE / ACCEPTABLE IN CHANGESET | [VLD-03 end-to-end integration](./recon/VLD-03-end-to-end-integration.md) | Verified on `b88e81a700188d9dd7dc95d9be757a6b6b81f900`; not yet Human Integrated |
...
| VLD-03 | **EVIDENCE COMPLETE / ACCEPTABLE IN CHANGESET** | [Executed integration evidence](./recon/VLD-03-end-to-end-integration.md) on PR #52 merge base; Human Integration remains a separate gate |
...
| VLD-04 / VLD-05 | **BLOCKED** on their respective runtime and claims prerequisites | VLD-03 evidence is complete in this changeset; operational demo and final claims gates remain separate |
